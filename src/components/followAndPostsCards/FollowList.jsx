...
const FollowList = ({
  ...
  const { follower: followersList, following: followingList } = useSelector(
    (state) => state.profile
  );
  const { follower: followersOfCreator, following: followingOfCreator } =
    useSelector((state) => state.creatorProfile);
  ...
  return (
    <div className="w-full flex flex-col justify-center items-center">
      <div
        className="lg:hidden flex w-full justify-center mt-5 mx-0
       pb-5
     "
      >
      ...
      <div
        className="w-[85%] md:w-full flex flex-col justify-start items-center gap-4 bg-bg-color 
